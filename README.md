# Todd Cooke
Software Engineer
- [Resume](https://toddcooke.github.io/Todd_Cooke_Resume.pdf)
...
- Created Lambda microservices using Typescript
- Enabled CI/CD using unit, functional, integration, and performance tests
written in ScalaTest, Cucumber, and Gatling and run on Jenkins
- Persisted data with DynamoDB and Postgres with Aurora
- Developed features, fixed bugs, and addressed tech debt for services written
in Scala and Java
